...
import { _login } from "../store/Reducer";
import { Auth } from "aws-amplify"

function LoginComponent() {
    const history = useHistory()
    const [email, setEmail] = React.useState<string>("crudavid")
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <button onClick={() => history.push("/register")} className="focus:outline-none font-medium text-blue-600 hover:text-blue-500">
                                    No account?
                                </button>
                            </div>
                        </div>
